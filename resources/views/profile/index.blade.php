        ...
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="bg-white overflow-hidden shadow-sm rounded-lg mb-4">
                <div class="px-3 py-3 text-gray-900">
                    <ul class="space-y-3 text-md">
                        <li class="border-b-2 py-2 hover:text-emerald-500">
                            <a href="{{route('alergics.index')}}" class="flex items-center space-x-4"><i class="fas fa-heart"></i> <span>Alergi</span></a>
                        </li>
                        <li class=" py-2 hover:text-emerald-500">
                            <a href="{{route('diseases.index')}}" class="flex items-center space-x-4"><i class="fas fa-virus"></i> <span>Riwayat Penyakit</span></a>
                        </li>
                    </ul>
                </div>
            </div>
