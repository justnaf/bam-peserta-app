<nav class="fixed bottom-0 bg-white flex items-center max-w-sm w-full mx-auto">
    ...
    <x-nav-link :href="route('profile.index')" :active="request()->routeIs('profile.*') | request()->routeIs('datadiri.*')">
