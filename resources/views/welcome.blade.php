...
<body class="flex flex-col items-center min-h-screen justify-center space-y-2">
    ...
    <nav class="mb-8 space-x-2">
        ...
        <a href=" {{ route('register') }}" class="rounded-md px-3 py-2 ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20] bg-blue-500 text-white">
            Register
        </a>
        @endif
        @endauth
